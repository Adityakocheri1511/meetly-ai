# main.py  – Meetly.AI Gemini Edition
import os
...
origins = [
    "https://meetly-ai-frontend.vercel.app",  # your deployed frontend
...
# -------------------------
# Root and Health Endpoints (for Render health checks)
# -------------------------
@app.api_route("/", methods=["GET", "HEAD"])
async def root():
    """Render root health endpoint"""
...
async def submit_feedback(req: FeedbackRequest):
    ...
    con = sqlite3.connect(DB_FILE)
    cur = con.cursor()
    cur.execute("INSERT INTO feedback (user_email, message) VALUES (?, ?)", (req.user_email, req.message))
    con.commit()
    con.close()
